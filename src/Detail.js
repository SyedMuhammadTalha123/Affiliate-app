            ...
            <div>
                ...
                <body className="body">
                    ...
                    <div className="row ">
                        ...
                        <div className="col-lg-12 col-sm-12" style={{justifyContent:"center"}}>
                            <Carousel autoplay style={{ color: "white",justifyContent:"center"}}>
                    ...
                    <div className="container-fluid " style={{ width: "100%" }}>
                        <div className="row pt-5">
                            ...
                            <div className="text-left col-xs-6 col-sm-4 col-lg-4 offset-lg-1 pt-5" style={{ fontSize: "20px", fontFamily: "lft-etica,sans-serif" }}>
                            ...
                            <div className="col-xs-12 col-sm-4 col-lg-3  offset-lg-1">
                                <img src="../mobile.jpg" width="700px" height="500px" className="img-responsive standard-text-block-image" alt="Responsive image" />
                            </div>
                        </div>


                        <div className="row pt-5">
                            <div className="col-sm-6 col-lg-3  offset-lg-1" style={{ fontSize: "20px", fontFamily: "lft-etica,sans-serif" }}>
                                <img src="../aff.jpg" width="600px" height="500px" className="img-responsive standard-text-block-image" alt="Responsive image" />

                            </div>
                            <div className="col-sm-6 col-xs-12 col-lg-4 offset-sm-1 offset-lg-3 pt-5" style={{ fontSize: "20px", fontFamily: "lft-etica,sans-serif" }}>
                        ...
                        <div className="row pt-5">
                            ...
                            <div className="col-xs-12 col-lg-4  offset-lg-1 pt-5 " style={{ fontSize: "20px", fontFamily: "lft-etica,sans-serif" }}>
                        ...
                        <div className="row pt-5">
                            ...
                            <div className="col-xs-12 col-sm-12 col-lg-4  offset-lg-3 pt-5 " style={{ fontSize: "20px", fontFamily: "lft-etica,sans-serif" }}>
                                <h1 style={{ color: "#4B0082" }}>For Publisher Partners</h1>
                        ...
                        <div className="row pt-5">
                            ...
                            <div className="col-sm-4 col-lg-3 offset-lg-1 mt-5 mb-5 pb-5">
