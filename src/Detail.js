    ...
    render() {
        return (
            ...
            <div>
                ...
                <body className="width w-sm-100">
                    <Navigation />

                    <div className="row " >

                        <div className="col-lg-12 col-sm-12 detailpage" >
                    ...
                    <div className="container-fluid detail" >
                        <div className="row pt-5">
                            ...
                            <div className="col-xs-12 col-sm-6 col-lg-6  offset-lg-1">
                                <img src="../mobile.jpg" width="600px" height="500px" alt="Responsive image" />
                            </div>
                        </div>


                        <div className="row pt-5">
                            <div className="col-sm-12 col-lg-3  offset-lg-1 detailimage" >
                                <img src="../aff.jpg" width="600px" height="500px" className="img-responsive standard-text-block-image" alt="Responsive image" />

                            </div>
                            <div className="col-sm-12 col-xs-12 col-lg-4 offset-sm-1 offset-lg-3 pt-5 detailimage" >
                                <h1 style={{ color: "#4B0082" }}>For Agencies</h1>
                                <p className="detailparagraph">You need an affiliate marketing partner with reach and scale. Our team provides unparalleled affiliate marketing support with publisher expansion, campaign optimisation, reporting and more.</p>
                            </div>
                        ...
                        <div className="row pt-5">
                            ...
                            <div className="col-xs-12 col-lg-4  offset-lg-1 pt-5 detailimage " >
                                <h1 style={{ color: "#4B0082" }}>For Publisher Partners</h1>
                                <p className="detailparagraph">Work with the top brands across industries, from fashion to financial services and more. Whether you’re a blogger, influencer, app developer or business, our premier global publisher network has you covered.</p>
                            </div>
                            <div className="col-xs-12 col-sm-12 col-lg-3  offset-lg-2">
                                <img src="../sev.jpg" width="500px" height="500px" className="img-responsive standard-text-block-image" alt="Responsive image" />
                        ...
                        <div className="row pt-5">
                            ...
                            <div className="col-xs-12 col-sm-12 col-lg-3  offset-lg-1">
                                <img src="../affiliate.jpg" width="600px" height="500px" className="img-responsive standard-text-block-image" alt="Responsive image" />

                            </div>
                            <div className="col-xs-12 col-sm-12 col-lg-4  offset-lg-3 pt-5 detailimage " >
                                <h1 style={{ color: "#4B0082" }}>For Publisher Partners</h1>
                                <p className="detailparagraph">Work with the top brands across industries, from fashion to financial services and more. Whether you’re a blogger, influencer, app developer or business, our premier global publisher network has you covered.</p>
                            </div>
                        ...
                        <div className="row pt-5">
                            ...
                            <div className="col-xs-12 col-sm-12 col-lg-5  offset-lg-1 pt-3 " style={{ fontSize: "20px", fontFamily: "lft-etica,sans-serif" }}>
                            ...
                            <div className=" col-xs-12 col-sm-12 col-lg-3 offset-lg-1 mt-5 mb-5 pb-5">
                                <img src="../kl.jpg" width="500px" height="500px" className="img-wrapper" alt="Responsive image" />
