            ...
            <div>
                ...
                <div className="container-fluid " style={{ width: "100%" }}>
                    <div className="row pt-5">
                        ...
                        <div className="text-left col-sm-6 col-lg-4 offset-lg-1 pt-5" style={{ fontSize: "20px", fontFamily: "lft-etica,sans-serif" }}>
                    ...
                    <div className="row pt-5">
                        ...
                        <div className="col-sm-12 col-lg-4 offset-sm-1 offset-lg-3 pt-5" style={{ fontSize: "20px", fontFamily: "lft-etica,sans-serif" }}>
                    ...
                    <div className="row pt-5">
                        ...
                        <div className="col-sm-12 col-lg-4  offset-lg-3 pt-5 " style={{ fontSize: "20px", fontFamily: "lft-etica,sans-serif" }}>
                            <h1 style={{ color: "#4B0082" }}>For Publisher Partners</h1>
