            ...
            <div>
                ...
                <div className="container-fluid " style={{ width: "100%" }}>
                    <div className="row pt-5">
                        ...
                        <div className="text-left col-xs-6 col-sm-6 col-lg-4 offset-lg-1 pt-5" style={{ fontSize: "20px", fontFamily: "lft-etica,sans-serif" }}>
                    ...
                    <div className="row pt-5">
                        <div className="col-sm-12 col-lg-3  offset-lg-1" style={{ fontSize: "20px", fontFamily: "lft-etica,sans-serif" }}>
                            <img src="../aff.jpg" width="600px" height="500px" className="img-responsive standard-text-block-image" alt="Responsive image" />

                        </div>
                        <div className="col-sm-12 col-xs-12 col-lg-4 offset-sm-1 offset-lg-3 pt-5" style={{ fontSize: "20px", fontFamily: "lft-etica,sans-serif" }}>
                    ...
                    <div className="row pt-5">
                        ...
                        <div className="col-xs-12 col-lg-5  offset-lg-1 pt-3 " style={{ fontSize: "20px", fontFamily: "lft-etica,sans-serif" }}>
                        ...
                        <div className="col-sm-12 col-lg-3 offset-lg-1 mt-5 mb-5 pb-5">
